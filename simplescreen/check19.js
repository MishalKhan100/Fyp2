...
const start = async () => {
  ...
  await TrackPlayer.add({
    id: 'track',
    url: require('../letters/019-ghain.mp3'),
  })
  await TrackPlayer.play();
};


export default class check19 extends Component {
  constructor(props) {
    super(props)
      ...
      <View>
        ...
        <View style={styles.mainContainer}>
          ...
          <View style={styles.mainheader}>
            ...
            <TouchableOpacity activeOpacity={1}
              onPress={() => this.props.navigation.navigate('check20')}                 
            >
              <Image
          ...
          <View style={{ flexDirection: 'row' }}>
            ...
            <View style={{ flexDirection: 'column' }}>
              ...
              >
                <Image
                  source={require('../withoutback/c19.png')}
                  style={{
