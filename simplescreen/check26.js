...
const start = async () => {
  ...
  await TrackPlayer.add({
    id: 'track',
    url: require('../letters/026-waw.mp3'),
  })
  await TrackPlayer.play();
};


export default class check26 extends Component {
  constructor(props) {
    super(props)
      ...
      <View>
        ...
        <View style={styles.mainContainer}>
          ...
          <View style={styles.mainheader}>
            ...
            <TouchableOpacity activeOpacity={1}
              onPress={() => this.props.navigation.navigate('check27')}                 
            >
              <Image
          ...
          <View style={{ flexDirection: 'row' }}>
            ...
            <View style={{ flexDirection: 'column' }}>
              ...
              >
                <Image
                  source={require('../withoutback/c27.png')}
                  style={{
