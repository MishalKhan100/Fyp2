...
const start = async () => {
  ...
  await TrackPlayer.add({
    id: 'track',
    url: require('../letters/029-yaa.mp3'),
  })
  await TrackPlayer.play();
};


export default class check28 extends Component {
  constructor(props) {
    super(props)
  ...
  testing() {
    RNVoiceRecorder.Record({
      format: 'wav',
      onDone: (path1) => {
        console.log('record done: ' + path1)
        recordingPath1 = path1;
        this.setState({
          showlebal:true,
      ...
      <View>
        ...
        <View style={styles.mainContainer}>
          ...
          <View style={styles.mainheader}>
            ...
            style={{ height: 62, width: 100, marginLeft: 200, marginTop: 10}}>
          ...
          <View style={{ flexDirection: 'row' }}>
            ...
            <View style={{ flexDirection: 'column' }}>
              ...
              >
                <Image
                  source={require('../withoutback/c28.png')}
                  style={{
