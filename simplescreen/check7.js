...
const start = async () => {
  ...
  await TrackPlayer.add({
    id: 'track',
    url: require('../letters/007-khaa.mp3'),
  })
  await TrackPlayer.play();
};


export default class check7 extends Component {
  constructor(props) {
    super(props)
      ...
      <View>
        ...
        <View style={styles.mainContainer}>
          ...
          <View style={styles.mainheader}>
            ...
            <TouchableOpacity activeOpacity={1}
              onPress={() => this.props.navigation.navigate('check8')}                 
            >
              <Image
          ...
          <View style={{ flexDirection: 'row' }}>
            ...
            <View style={{ flexDirection: 'column' }}>
              ...
              >
                <Image
                  source={require('../withoutback/c7.png')}
