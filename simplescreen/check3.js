...
const start = async () => {
  ...
  await TrackPlayer.add({
    id: 'track',
    url: require('../letters/003-taa.mp3'),
  })
  await TrackPlayer.play();
};


export default class check3 extends Component {
  constructor(props) {
    super(props)
      ...
      <View>
        ...
        <View style={styles.mainContainer}>
          ...
          <View style={styles.mainheader}>
            ...
            <TouchableOpacity activeOpacity={1}
              onPress={() => this.props.navigation.navigate('check4')}                 
            >
              <Image
 ...
 >
                <Image
                  source={require('../withoutback/c3.png')}
                  style={{
                    marginTop: 20, borderWidth: 2,justifyContent:'center', borderRadius: 20, borderColor: 'black',
