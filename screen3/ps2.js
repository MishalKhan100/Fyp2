...
const start = async () => {
  ...
  await TrackPlayer.add({
    id: 'track',
    url: require('../newletter/baazer.mp3'),
  })
  await TrackPlayer.play();
};


export default class ps2 extends Component {
  constructor(props) {
    super(props)
        ...
        <View style={styles.mainContainer}>
          ...
          <View style={{ flexDirection: 'row' }}>
            ...
            <View style={{ flexDirection: 'column' }}>
              ...
              >
                <Image
                  source={require('../without2/r2.png')}
                  style={{
          ...
          <View style={styles.footer}>
            ...
            >
              <Image
                source={require('../withoutback/child3.png')}
                style={{
                  height: 220, width: 170, marginTop: 20, marginLeft: 40,
                }} />
            </TouchableOpacity>
